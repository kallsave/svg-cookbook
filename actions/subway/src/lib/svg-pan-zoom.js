...
(function e(t, n, r) {
  ...
  3: [function (require, module, exports) {
    ...
    ShadowViewport.prototype.setCTM = function (newCTM) {
      ...
      if (willZoom || willPan) {
        ...
        // Before pan
        if (willPan) {
          var preventPan = this.options.beforePan(this.getPan(), { x: newCTM.e, y: newCTM.f }) // If prevent pan is an object
  ...
  4: [function (require, module, exports) {
    ...
    var ControlIcons = require('./control-icons')
    var Utils = require('./utilities')
    var SvgUtils = require('./svg-utilities')
    var ShadowViewport = require('./shadow-viewport')
    ...
    SvgPanZoom.prototype.getPublicInstance = function () {
      ...
      if (!this.publicInstance) {
        this.publicInstance = this.pi = {
          ...
          getPan: function () { return that.getPan() }, // Pan event

          setBeforePan: function (fn) { that.options.beforePan = fn === null ? null : Utils.proxy(fn, that.publicInstance); return that.pi },
          setOnPan: function (fn) { that.options.onPan = fn === null ? null : Utils.proxy(fn, that.publicInstance); return that.pi }, // Zoom and Control Icons
          ...
          isControlIconsEnabled: function () { return !!that.options.controlIconsEnabled }, // Double click zoom

          enableDblClickZoom: function () { that.options.dblClickZoomEnabled = true; return that.pi },
          disableDblClickZoom: function () { that.options.dblClickZoomEnabled = false; return that.pi },
          isDblClickZoomEnabled: function () { return !!that.options.dblClickZoomEnabled }, // Mouse wheel zoom

          enableMouseWheelZoom: function () { that.enableMouseWheelZoom(); return that.pi },
          disableMouseWheelZoom: function () { that.disableMouseWheelZoom(); return that.pi },
          isMouseWheelZoomEnabled: function () { return !!that.options.mouseWheelZoomEnabled }, // Zoom scale and bounds

          setZoomScaleSensitivity: function (scale) { that.options.zoomScaleSensitivity = scale; return that.pi },
          setMinZoom: function (zoom) { that.options.minZoom = zoom; return that.pi },
          setMaxZoom: function (zoom) { that.options.maxZoom = zoom; return that.pi }, // Zoom event

          setBeforeZoom: function (fn) { that.options.beforeZoom = fn === null ? null : Utils.proxy(fn, that.publicInstance); return that.pi },
          setOnZoom: function (fn) { that.options.onZoom = fn === null ? null : Utils.proxy(fn, that.publicInstance); return that.pi }, // Zooming
          ...
          getZoom: function () { return that.getRelativeZoom() }, // CTM update

          setOnUpdatedCTM: function (fn) { that.options.onUpdatedCTM = fn === null ? null : Utils.proxy(fn, that.publicInstance); return that.pi }, // Reset

          resetZoom: function () { that.resetZoom(); return that.pi },
          resetPan: function () { that.resetPan(); return that.pi },
          reset: function () { that.reset(); return that.pi }, // Fit, Contain and Center

          fit: function () { that.fit(); return that.pi },
          contain: function () { that.contain(); return that.pi },
          center: function () { that.center(); return that.pi }, // Size and Resize
  ...
  6: [function (require, module, exports) {
    ...
    module.exports = (function () {
      ...
      var prefix = ''
      var _addEventListener; var _removeEventListener; var onwheel; var support; var fns = []
